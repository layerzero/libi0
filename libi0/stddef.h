...
#define AMR_P_NONREP_OFFSET_SIZE AMR_P_OFFSET_SIZE
...
#define AMR_P_NONREP_OFFSET_BEGIN AMR_P_OFFSET_BEGIN
#define AMR_P_NONREP_OFFSET_END (AMR_P_NONREP_OFFSET_BEGIN + AMR_P_NONREP_OFFSET_SIZE - 1)
